    ...
    <div class="row">
        ...
        <div class="col-md-9 single-element listview">
            ...
            <div class="searchbuttontabs">
                <a href="{{url('search/category',['Products',$data['id']])}}">
                        ...
                        @foreach($products as $product)
                            ...
                            <tr>
                                <td class="cart_product"  width="20%">
                                    <a href="{{url('single-buying-request',[$product->id])}}"><img width="150px" src="{{first_image($product->images)}}" alt=""></a>
                                </td>
                                <td class="cart_description"  width="70%">
                                    <h4 style="margin-bottom: 10px; margin-top: 0px;"><a
                                                href="{{url('single-buying-request',[$product->id])}}">{{$product->product_name}}</a>
                                    </h4>
